...
timer: function(){
    ...
    setInterval(function(){
        ...
        console.log("h:"+hDate+" m:"+mDate+" s:"+sDate);
        console.log("S:"+(sDate-pastsDate));
        console.log("M:"+(mDate-pastmDate));
        console.log("H:"+(hDate-pasthDate));
        if(sDate-pastsDate==1&&mDate-pastmDate==0&&hDate-pasthDate==0)
        {
            seconds++;
        }else if(sDate-pastsDate<1&&mDate-pastmDate==1||hDate-pasthDate==1){
            seconds++;
        }
        if( seconds == 60 ){
            minutes++;
