$(function() {
    ...
    $("#btt_start").on('click', study);
    $("#btt_about").on('click', about);
...
function about(){
    ...
    $("#about").fadeIn(300, "linear");
    $("#about_cover").fadeIn(300, "linear");
